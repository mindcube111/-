...
import { onRequestPost as __api_update_invite_usage_js_onRequestPost } from "C:\\Users\\26872\\Desktop\\心理网站编写\\怪奇物语测试\\functions\\api\\update-invite-usage.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_update_invite_usage_js_onRequestPost],
    },
  {
